...
// Returns the private 'security.firewall.map.context.user_login' shared service.
...
$c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($b, '/'), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'user_logout']);
...
return $this->privates['security.firewall.map.context.user_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ($this->privates['security.authentication.listener.guard.user_login'] ?? $this->load('getSecurity_Authentication_Listener_Guard_UserLoginService.php'));
    yield 3 => ($this->privates['security.authentication.listener.anonymous.user_login'] ?? $this->load('getSecurity_Authentication_Listener_Anonymous_UserLoginService.php'));
    yield 4 => ($this->privates['security.access_listener'] ?? $this->load('getSecurity_AccessListenerService.php'));
}, 5), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), $b, 'user_login', ($this->privates['App\\Security\\UserAuthenticator'] ?? $this->load('getUserAuthenticatorService.php')), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->load('getMonolog_Logger_SecurityService.php')), false), $c, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('user_login', 'security.user_checker', '.security.request_matcher.3UEFixr', true, false, 'security.user.provider.concrete.users', 'user_login', 'App\\Security\\UserAuthenticator', NULL, NULL, [0 => 'guard', 1 => 'anonymous'], NULL));
