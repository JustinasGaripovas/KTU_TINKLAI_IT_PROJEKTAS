...
// Returns the private 'App\Repository\ExaminationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ExaminationRepository.php';

return $this->privates['App\\Repository\\ExaminationRepository'] = new \App\Repository\ExaminationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
