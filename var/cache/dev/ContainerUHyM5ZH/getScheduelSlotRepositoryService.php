...
// Returns the private 'App\Repository\ScheduelSlotRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ScheduelSlotRepository.php';

return $this->privates['App\\Repository\\ScheduelSlotRepository'] = new \App\Repository\ScheduelSlotRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
