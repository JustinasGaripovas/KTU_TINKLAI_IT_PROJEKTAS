...
// Returns the private 'App\Repository\UserCardRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserCardRepository.php';

return $this->privates['App\\Repository\\UserCardRepository'] = new \App\Repository\UserCardRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
