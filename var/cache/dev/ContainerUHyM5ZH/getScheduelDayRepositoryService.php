...
// Returns the private 'App\Repository\ScheduelDayRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ScheduelDayRepository.php';

return $this->privates['App\\Repository\\ScheduelDayRepository'] = new \App\Repository\ScheduelDayRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
