...
// Returns the private 'App\Repository\ScheduelRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ScheduelRepository.php';

return $this->privates['App\\Repository\\ScheduelRepository'] = new \App\Repository\ScheduelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
