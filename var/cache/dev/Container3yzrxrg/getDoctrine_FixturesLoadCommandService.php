...
include_once $this->targetDirs[3].'/src/DataFixtures/ScheduleSlotFixture.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ScheduleSlotFixture(), 'groups' => []]]);
