...
// Returns the private 'App\Repository\StudentasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StudentasRepository.php';

return $this->privates['App\\Repository\\StudentasRepository'] = new \App\Repository\StudentasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
