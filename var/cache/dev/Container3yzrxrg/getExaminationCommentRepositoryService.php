...
// Returns the private 'App\Repository\ExaminationCommentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ExaminationCommentRepository.php';

return $this->privates['App\\Repository\\ExaminationCommentRepository'] = new \App\Repository\ExaminationCommentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
