...
// Returns the private 'App\Repository\ExaminationCommentsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ExaminationCommentsRepository.php';

return $this->privates['App\\Repository\\ExaminationCommentsRepository'] = new \App\Repository\ExaminationCommentsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
